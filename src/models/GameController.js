...
export class GameController {
    constructor(ui){
        ...
        this.world = [
            ...
            new Container(this, "Coffre", "idle", [
                new GameObject(this.game, "Cendres", "https://image.flaticon.com/icons/png/512/3885/3885190.png", "Ashes", "idle")
            ])
        ...
        this.quack = setInterval(
            () => {
                if (this.timer > 0) {    
                    this.timer--;
                } else {
                    alert("C'est perdu !");
                    clearInterval(this.quack);
                }
            }, 1000
        )
    }
